...
class Recipe extends Component{
    ...
    createIngredient = ingredient =>{
        ...
        <li className="recipe__item" key={ingredient.id}>
            ...
            <div className="recipe__count">{this.formatCount(ingredient.count)}</div>
            ...
            return(
                <div className="recipe" onClick = {this.recipeButtonClick}>
                    ...
                    <figure className="recipe__fig">
                        <img src= {this.props.img} alt= {this.props.title} className="recipe__img" />
                    ...
                    <div className="recipe__details">
                        <div className="recipe__info">
                            ...
                            <span className="recipe__info-data recipe__info-data--minutes">{this.props.time}</span>
                        ...
                        <div className="recipe__info">
                            ...
                            <span className="recipe__info-data recipe__info-data--people">{this.props.servings}</span>
                    ...
                    <div className="recipe__directions">
                        ...
                        <a className="btn-small recipe__btn" href={this.props.url} target="_blank" rel="noopener noreferrer">
                ...
                return (
                    <div className="recipe heading-2" >
                            Nothing
                    </div>
                )}
